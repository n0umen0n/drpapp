...
*/
    ...
    typedef eosio::multi_index<"casestbbb"_n, casestbbb,
    indexed_by<"bynumber"_n, const_mem_fun<casestbbb, uint64_t, &casestbbb::get_by_number>>> cases_t;
    ...
    typedef eosio::multi_index<"configtbb"_n, configtbb> config_t;
    ...
    */
    ...
    ACTION modifytimes(uint32_t time_for_arb_to_accept, uint32_t time_for_respondent_to_acknowledge, uint32_t time_for_respondent_to_respond, uint32_t time_for_arbitrators_to_give_verdict);
    ...
    ACTION giveverdict(name case_winner,name lead_arbitrator, name community, uint64_t case_id, vector<asset> fine_verdict, vector<asset> relief_verdict, vector<uint16_t> suspension_verdict, string verdict_description, vector<string> ipfs_cid_verdict, bool ban_verdict);
    ...
    ACTION timetoclose(uint64_t case_id, name community);
